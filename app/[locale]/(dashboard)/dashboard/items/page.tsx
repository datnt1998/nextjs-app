      ...
      <Stack direction="vertical" gap="lg">
        ...
        <Stack direction="horizontal" justify="between" align="center">
          ...
          <Stack direction="horizontal" gap="sm">
            <Link href={`/${locale}/dashboard/items/table`}>
            ...
            <Can permission={PERMISSIONS.ITEMS_CREATE}>
              <Link href={`/${locale}/dashboard/items/new`}>
        ...
        <Card>
          <CardContent className="pt-6">
            <Stack direction="vertical" gap="md">
              ...
              {/* Status Filter */}
              <div>
                <p className="mb-2 text-sm font-medium">{t("filters.title")}</p>
                <Stack direction="horizontal" gap="sm">
                  <Button
                    variant={
                      statusFilter.includes("active") ? "default" : "outline"
                    }
                    size="sm"
                  ...
                  <Button
                    variant={
                      statusFilter.includes("inactive") ? "default" : "outline"
                    }
                    size="sm"
                  ...
                  <Button
                    variant={
                      statusFilter.includes("archived") ? "default" : "outline"
                    }
                    size="sm"
        ...
        {error && (
          <Card>
            <CardContent className="py-12 text-center">
              <p className="text-danger">{t("errors.loadFailed")}</p>
            </CardContent>
          </Card>
        )}
        ...
        {!isLoading && !error && data && data.items.length === 0 && (
          <Card>
            <CardContent className="py-12 text-center">
              ...
              <Can permission={PERMISSIONS.ITEMS_CREATE}>
                <Link href={`/${locale}/dashboard/items/new`}>
                  <Button>{t("actions.createItem")}</Button>
                </Link>
              </Can>
            </CardContent>
          </Card>
          ...
          <>
            <Grid cols={3} gap="md">
              {(data.items as Item[]).map((item) => (
                <Link
                  key={item.id}
                  href={`/${locale}/dashboard/items/${item.id}`}
                >
